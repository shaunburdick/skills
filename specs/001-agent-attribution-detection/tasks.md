...
- [ ] T-007: Release — `git identity` check (done: Shaun Burdick <github@shaunburdick.com>), review diff, commit, push branch, open PR with `Generated-By` footer per ai-attribution skill.